                    ...
                    try{
                      ...
                      foreach($stmt as $row){
                        ...
                        if($row['status'] == 'A'){
                          ...
                          $status = "<button class='btn btn-danger btn-sm btn-flat'>Deactivated</button>";
                        }
                        $edit_btn = "";
                        if($row['status'] != 'I'){ 
                          $status_btn = "<button class='btn btn-danger delete btn-sm deactivate btn-flat' data-id='".$row['id']."'> Deactivate</button>";
                          $edit_btn = " <button class='btn btn-success btn-sm edit btn-flat' data-id='".$row['id']."'><i class='fa fa-edit'></i> Edit</button> ";
                        }else{  
                          $status_btn = "";
                          $edit_btn = "";
                        } 

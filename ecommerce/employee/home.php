      ...
      <div class="row">
        <div class="col-lg-4 col-xs-6">
          ...
          <div class="small-box bg-aqua">
            <div class="inner">
              <?php
                $stmt = $conn->prepare("SELECT * FROM details LEFT JOIN products ON products.id=details.product_id where products.seller_id=".$employee['id']);
                $stmt->execute();
        ...
        <div class="col-lg-4 col-xs-6"> 
          <div class="small-box bg-red">
            <div class="inner">
              <?php
                $stmt = $conn->prepare("SELECT * FROM details LEFT JOIN sales ON sales.id=details.sales_id LEFT JOIN products ON products.id=details.product_id WHERE sales_date=:sales_date and products.seller_id=".$employee['id']);

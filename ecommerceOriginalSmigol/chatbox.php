				...
				<div class="card chat-app">
					...
					<div class="chat  col-8">
						...
						<div class="chat-header clearfix header"> 
							<div class="row"  id="avatar_section">  
								<div class="col-lg-6">
						...
						<div class="box-footer"  id="sender_section"> 
...
$(function(){  
	...
	$(document).on('click', '.clickChatbox', function(e){ 
		...
		var x2 = document.getElementById("avatar_section");
	...
	function fetchMsg(id){ 
		...
		var x = document.getElementById("sender_section");
		var x2 = document.getElementById("avatar_section");
		...
		// console.log(container.scrollHeight,document.getElementById("scrollHeight"))
		$.ajax({
			type: 'POST',
	...
	$(document).on('click', '.clickSendMessage', function(e){
		...
		console.log(!parseInt(atob(localStorage.getItem("job_id"))))
...
function openNav() { 
	...
	document.getElementById("plist").style.left = "0px"; 
}

function closeNav() { 
	document.getElementById("openbtn").style.display = "block"; 
	document.getElementById("plist").style.width = "0";  
	document.getElementById("plist").style.left = "-50px"; 

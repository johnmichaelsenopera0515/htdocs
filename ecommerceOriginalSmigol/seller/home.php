      ...
      <div class="row">
        <div class="col-lg-4 col-xs-6">
          ...
          <div class="small-box bg-aqua">
            <div class="inner">
              <?php
                $stmt = $conn->prepare("SELECT * FROM job_order a left join products b on a.product_id = b.id WHERE b.seller_id=".$seller['id']);
                $stmt->execute();
        ...
        <div class="col-lg-4 col-xs-6">
          ...
          <div class="small-box bg-green">
            <div class="inner">
              <?php
                $stmt = $conn->prepare("SELECT *, COUNT(*) AS numrows FROM products where products.status != 'I' AND products.seller_id=".$seller['id']);
                $stmt->execute();
                $prow =  $stmt->fetch();
        ...
        <div class="col-lg-4 col-xs-6"> 
          <div class="small-box bg-red">
            <div class="inner">
              <?php
                $stmt = $conn->prepare("SELECT * FROM job_order a left join products b on a.product_id = b.id WHERE a.request_date=:sales_date and b.seller_id=".$seller['id']);
